 ...
 * BEP20 — «0x» и сорок шестнадцатеричных знаков, адрес Ethereum: BSC
 * повторяет его форму знак в знак.
 *
 * Регистр шестнадцатеричной части у BEP20 не значит ничего: кошелёк
 * отдаёт адрес и строчными, и в виде EIP-55, где заглавные и есть
 * контрольная сумма. Её, как base58check у TRON и CRC16 у TON, здесь не
 * считают: это отдельная работа — своя реализация SHA-256, base58 и
 * keccak в браузерном пакете, — и она записана в `backlog.md`.
 */

 ...
 *
 * Рисуют её двое: аналитика панели и аналитика мерчанта. Ступени у них
 * разные — у мерчанта нет чужих заявок, — а вид один: две воронки,
 * расходящиеся в высоте полосы, читались бы как два разных показателя.
 */

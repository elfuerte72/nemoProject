 ...
 *
 * Наличные сюда не идут, хотя курс у них теперь бывает: наличную сделку
 * ведёт только менеджер — место, время, встреча, — и справка, назвавшая
 * её курс, звала бы клиента договариваться с помощником о том, чего он
 * не решает. Молчащий источник — тоже рабочее состояние: справка тогда

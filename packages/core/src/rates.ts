 ...
 *
 * Наличные через этот интерфейс не проходят вовсе: там ставку называет
 * менеджер, и котировка биржи к ней отношения не имеет.
 *
 ...
 * отталкивался, а разбор спорной сделки не упирался в «мне показывали

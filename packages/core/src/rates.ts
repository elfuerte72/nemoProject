 ...
 * должны.
 *
 * Наличные проходят через него же, но по своей ставке: биржевую
 * котировку они берут ту же, а сетку — отдельную. Ставки нет — нет и
 * курса: наценка перевода к наличному обмену не относится.
 *

...
export interface CoreConfig {
  ...
  /**
   * Чем начинаются ключи API на этом контуре: `sk_live_` на боевом,
   * `sk_test_` на песочнице. Нужен только кабинету, и только выпуску
   * ключа: узнаётся ключ по хешу, а префикс говорит человеку, куда ключ
   * ведёт, до первого вызова.
   */

...
ALTER TABLE "service_settings" ADD COLUMN "unpaid_exchange_request_ttl_minutes" integer DEFAULT 120 NOT NULL;--> statement-breakpoint
...
ALTER TABLE "service_settings" ADD CONSTRAINT "service_settings_ttl_positive" CHECK ("service_settings"."unpaid_exchange_request_ttl_minutes" > 0);
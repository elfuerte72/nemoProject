 ...
 * байт. При обновлении раз в десять секунд разница выходит в полмегабайта
 * в минуту, выброшенных ради строки. Списком пары не спросить — на
 ...
 * биржи в `rapira.ts`, и по той же причине: обновление никого не
 * задерживает — устаревшее отдаётся сразу, за свежим идут в фоне.
 */
 ...
 * соседней биржи: по такому курсу подают заявку, а она обязательство.
 */

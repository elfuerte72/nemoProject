 ...
 *
 * Час, а не десять секунд, как у биржи: ЕЦБ публикует курсы раз в
 * рабочий день, и ходить к нему чаще незачем — ответ будет тот же.
 * Обновление всё равно никого не задерживает, так что час здесь не
 * компромисс, а отсутствие смысла спрашивать чаще.
 */
 ...
 *
 * Сутки — против пяти минут у биржи, и это не послабление, а разная
 * природа чисел: криптовалютная котировка живёт секундами, а опорный

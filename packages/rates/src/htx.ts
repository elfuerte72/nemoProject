 ...
 * там как CNH, оффшорный юань, и это правильная сторона: расчёты в USDT
...
/**
 * Через сколько котировка просит обновления. Минута, а не десять секунд
 * биржи: P2P-цена меняется шагом в копейку и заметно медленнее рынка, а
 * адрес недоговорный — стучать в него чаще нужного значит напрашиваться
 * на отказ.
 */
 ...
 * бирж: по такому курсу подают заявку, а она обязательство.
 */

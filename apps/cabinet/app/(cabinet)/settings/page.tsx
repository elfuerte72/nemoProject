 ...
 *
 * Наценка POS-терминала стояла здесь несколько часов 22 сентября 2026
 * и вернулась на свой экран: владелец посмотрел и попросил задавать её
 * прямо в терминале. Место у неё одно — два поля для одного числа

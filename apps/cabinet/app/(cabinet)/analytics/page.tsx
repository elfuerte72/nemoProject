              ...
              <tbody>
                {table.rows.map((row, at) => (
                  ...
                  <tr
                     ...
                     * счетов в одном банке с одинаковым хвостом номера
                     * подписи совпадают, и React увидел бы два узла с
                     * одним ключом. Порядок строк задаёт сервер и держит
                     * до следующего ответа.
                     */
                    key={at}
                    className={

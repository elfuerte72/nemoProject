 ...
 * сетка комиссии. Способ берётся из реквизита: карта и телефон — банк,
 * кошелёк — кошелёк, и ставка у них разная.
 *
 * Наличных здесь нет: их не котирует никто, цену им называет менеджер,
 * и сетка к ним не применяется.
 */
export const FEE_PAYOUT_LABELS: Record<'bank' | 'wallet', string> = {

 ...
 * что это было. Две с половиной секунды — столько, чтобы знак узнали, и
 * не столько, чтобы вход начал раздражать. Ровно столько же длится его
 * оборот: на быстрой сессии заставка уходит на замкнутом кадре, а не
 * посреди поворота.
 *
 ...
 *
 * Приветствие — про знакомство: клиент должен узнать знак и понять,

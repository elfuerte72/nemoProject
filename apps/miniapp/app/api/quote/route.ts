 ...
 *
 * Пустой ответ — рабочее состояние, а не ошибка: провайдер котировок
 * может лежать, а у наличных курса не бывает, пока им не заведена своя
 * ставка. Экран в обоих случаях говорит одно и то же — курс назовёт
 * менеджер.
 */

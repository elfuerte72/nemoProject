...
export function ExchangeScreen({
  ...
  useEffect(() => {
    /*
     * Курс спрашивается и у наличных: ставка у них своя, и пока
     * администратор её не завёл, сервер отвечает пустотой — то есть
     * ровно тем, чем отвечал раньше на всякую наличную заявку.
     */
    if (!fromCode || !toCode) {

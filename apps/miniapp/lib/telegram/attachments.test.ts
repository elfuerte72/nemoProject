...
/*
 * Сообщения — в форме, в какой их присылает Bot API
 * (core.telegram.org/bots/api): у фото лесенка размеров без имени и
 * типа, у документа имя, тип и размер, у голосового только тип и
 * размер. Наклейка и текст файлом не считаются.
 */
const BASE = {
  message_id: 1,
  date: 1_756_900_000,

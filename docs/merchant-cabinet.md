...
POS-терминал с имитацией приёма платежа и, с 23 сентября, счета по
устройству кабинета Love&Pay.
...
идеи до имитации приёма платежа и счетов по образцу Love&Pay.

| Дата | Что сделано |
| --- | --- |
| 23 сентября | Раздел «Возвраты» по образцу Love&Pay: четыре плитки с «В работе», «К возврату» с раскрытием по валютам, строка как у счёта, шапка ведёт к оплаченным счетам. Списки валют у «Счетов» и «Возвратов» открываются вниз. |
...
- Перед показом проверить, что кабинет отвечает и что на нём та версия,
  ...
  На 23 сентября 2026 оба контура на одном коде, примеры включены
  только на dev.

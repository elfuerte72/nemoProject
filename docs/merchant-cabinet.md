...
| Дата | Что сделано |
| --- | --- |
| 22 сентября | POS-терминал с имитацией приёма платежа: QR, срок счёта, «Покупатель заплатил», наценка и валюты владельца, верификация, возврат через провайдера, живая история, примеры (ADR-0024). Выкачено на тестовый контур 22 сентября вечером, в прод не выкачено. |

...
- **Плитки.** «Всего счетов» и «Оплаченные счета» с ходом по дням;
  ...
  нажатие раскрывает все валюты сервиса. Валюта сумм выбирается пилюлей
  «Оборот в [RUB ▾]» над плитками — той же, что в POS-терминале.
...
6. Счета: плитки и «Оборот в» с выбором валюты, раскрыть «По валютам»;
   ...
   станет «Возвращён».
7. Возвраты: список заявок с плитками по валютам.

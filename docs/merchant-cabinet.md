...
5. POS-терминал: набрать сумму в любой строке калькулятора и показать,
...
6. Счета: плитки и «Оборот в» с выбором валюты, раскрыть «По валютам»;
   ...
   станет «Возвращён».
7. Возвраты: плитки, раскрыть «К возврату» по валютам, строка с
   отметкой и «Подробнее» в карточку счёта.
8. Интеграция: ключи API, вебхуки с историей доставок, «Как встроить»,
   журнал вызовов, документация.
9. Сотрудники: завести оператора, показать, что он не видит
   интеграцию.

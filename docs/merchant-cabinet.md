...
принимает; список валют выдачи зависит от выбранной стороны. Под
...
вместе с курсом. Пустое поле означает работу без наценки; сохраняется
она по уходу из поля, и цена на экране пересчитывается сразу. Оператор

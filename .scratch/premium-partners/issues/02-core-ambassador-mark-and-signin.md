...
Сделано: миграция `0032_ambassadors`, операции заведения, снятия, возврата и входа, проверка подписи виджета переехала в `@nemo/telegram/login`. Пятнадцать тестов на настоящей базе. PR #120.
